...
export default function Modal_form() {
  ...
  const ValidationSchema = yup.object().shape({
    ...
    Description: yup.string().min(50, "Minmum 50 character required").required("Description is required"),
  ...
  const Typeoptions = [
    { label: "Library Mangment System"},
    { label: "Hospital Mangment" },
    { label: "Hotel mangment" },
    { label: "Ecommerce" },
    { label: "Chat App" },
    { label: "Materimonial"},
  ]
  return (
    <>
      <span onClick={handleShow}>Add Project</span>
