...
const Admin_chat = () => {
  ...
  const handleSendMsg = async (msg) => {
    ...
    console.log(currentchat.email, email, msg, gett());
  ...
  return (
    <Container>
      <div ref={profileRef} className="profile-container relative">
        <div
          className={`profile-menu h-[90vh] bg-white w-[90vw] md:w-[438px] fixed bottom-[1%] right-[2%] p-2 md:p-4 lg:p-4 rounded-[1rem] ${
            menu
        ...
        <button
          className="profile-trigger bg-[#ffffff94] z-50  flex items-center gap-2 md:gap-4 fixed right-[5%] bottom-[3%] border-[5px] p-[0.7rem] rounded-[1rem]"
